...
class Channels extends Component {
    ...
    addListeners = () => {
        let loadedChannels = [];  // get ALL channels and display

        // waiting anything new here
        this.state.channelsRef.on('child_added', snap => { // snap: infor about each child (channel)
    ...
    // put channel data on gobal state
...
export default connect(null, { setCurrentChannel, setPrivateChannel })(Channels) // put setCurrentChannel into Channel props